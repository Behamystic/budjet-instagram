    ...
    <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600">
                ...
                <a href="<?php echo e(route('login')); ?>" class="text-blue-600 hover:text-blue-800 font-medium">Sign in</a>
            </p>
        </div>
    </div>
...
<?php endif; ?>
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/behruz/Документы/ORM/resources/views/auth/register.blade.php ENDPATH**/ ?>