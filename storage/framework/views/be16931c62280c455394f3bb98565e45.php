            ...
            <div class="flex items-center">
                <div class="relative">  
                    ...
                    <div id="user-menu" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-10">
                        ...
                        <a href="<?php echo e(route("login")); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Sign out</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->yieldContent("content"); ?>
    ...
    </script><?php /**PATH /home/azizbek/Desktop/ORM/resources/views/layouts/app.blade.php ENDPATH**/ ?>